package uet.invincible.libs.swipelistview;

import static uet.invincible.libs.nineoldandroids.view.ViewHelper.setAlpha;
import static uet.invincible.libs.nineoldandroids.view.ViewHelper.setTranslationX;
import static uet.invincible.libs.nineoldandroids.view.ViewPropertyAnimator.animate;

import java.util.ArrayList;
import java.util.Collections;
import java.util.List;

import uet.invincible.libs.nineoldandroids.animation.Animator;
import uet.invincible.libs.nineoldandroids.animation.AnimatorListenerAdapter;
import uet.invincible.libs.nineoldandroids.animation.ValueAnimator;
import uet.invincible.libs.nineoldandroids.view.ViewHelper;
