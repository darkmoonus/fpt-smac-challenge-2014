...
public class StudentExamAdapter extends ArrayAdapter<StudentModel> {
	...
	public StudentExamAdapter(RobotMainActivity mActivity, Context context, int textViewResourceId, List<StudentModel> mStudentModel) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		ViewHolder holder = null;
			if (convertView == null) {
	            ...
	            convertView = mInflate.inflate(R.layout.item_row_student_exam, null);
	            holder.mStudentName = (TextView)convertView.findViewById(R.id.item_row_student_exam_name);
	            holder.mStudentInfo = (TextView)convertView.findViewById(R.id.item_row_student_exam_info);
	            holder.mStudentAvatar = (TextView)convertView.findViewById(R.id.item_row_student_exam_avatar);
	            holder.mExamScore = (TextView)convertView.findViewById(R.id.item_row_student_exam_score);
	            holder.mRowExam = (LinearLayout)convertView.findViewById(R.id.item_row_exam);
			...
			double sum = 0;
			sum += Double.parseDouble(mStudentModel.get(position).chuyenCan) * 0.1;
			sum += Double.parseDouble(mStudentModel.get(position).giuaKi) * 0.2;
			sum += Double.parseDouble(mStudentModel.get(position).cuoiKi) * 0.3;
			sum += Double.parseDouble(mStudentModel.get(position).tongKet) * 0.4;
			holder.mExamScore.setText(sum + "");
	...
	class ViewHolder {
		...
		public TextView mExamScore;
		public LinearLayout mRowExam;
	}
}
